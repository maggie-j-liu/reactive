 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e))try{this.getOrInitializeService({instanceIdentifier:"[DEFAULT]"})}catch(e){}try{for(var r=pe(this.instancesDeferred.entries()),i=r.next();!i.done;i=r.next()){var o=fe(i.value,2),s=o[0],a=o[1],l=this.normalizeInstanceIdentifier(s);try{var c=this.getOrInitializeService({instanceIdentifier:l});a.resolve(c)}catch(e){}}}catch(e){t={error:e}}finally{try{i&&!i.done&&(n=r.return)&&n.call(r)}finally{if(t)throw t.error}}}},e.prototype.clearInstance=function(e){void 0===e&&(e="[DEFAULT]"),this.instancesDeferred.delete(e),this.instances.delete(e)},e.prototype.delete=function(){return he(this,void 0,void 0,(function(){var e;return de(this,(function(t){switch(t.label){case 0:return e=Array.from(this.instances.values()),[4,Promise.all(ge(ge([],fe(e.filter((function(e){return"INTERNAL"in e})).map((function(e){return e.INTERNAL.delete()})))),fe(e.filter((function(e){return"_delete"in e})).map((function(e){return e._delete()})))))];case 1:return t.sent(),[2]}}))}))},e.prototype.isComponentSet=function(){return null!=this.component},e.prototype.isInitialized=function(e){return void 0===e&&(e="[DEFAULT]"),this.instances.has(e)},e.prototype.initialize=function(e){var t,n;void 0===e&&(e={});var r=e.options,i=void 0===r?{}:r,o=this.normalizeInstanceIdentifier(e.instanceIdentifier);if(this.isInitialized(o))throw Error(this.name+"("+o+") has already been initialized");if(!this.isComponentSet())throw Error("Component "+this.name+" has not been registered yet");var s=this.getOrInitializeService({instanceIdentifier:o,options:i});try{for(var a=pe(this.instancesDeferred.entries()),l=a.next();!l.done;l=a.next()){var c=fe(l.value,2),u=c[0],h=c[1];o===this.normalizeInstanceIdentifier(u)&&h.resolve(s)}}catch(e){t={error:e}}finally{try{l&&!l.done&&(n=a.return)&&n.call(a)}finally{if(t)throw t.error}}return s},e.prototype.onInit=function(e,t){var n,r=this.normalizeInstanceIdentifier(t),i=null!==(n=this.onInitCallbacks.get(r))&&void 0!==n?n:new Set;i.add(e),this.onInitCallbacks.set(r,i);var o=this.instances.get(r);return o&&e(o,r),function(){i.delete(e)}},e.prototype.invokeOnInitCallbacks=function(e,t){var n,r,i=this.onInitCallbacks.get(t);if(i)try{for(var o=pe(i),s=o.next();!s.done;s=o.next()){var a=s.value;try{a(e,t)}catch(e){}}}catch(e){n={error:e}}finally{try{s&&!s.done&&(r=o.return)&&r.call(o)}finally{if(n)throw n.error}}},e.prototype.getOrInitializeService=function(e){var t,n=e.instanceIdentifier,r=e.options,i=void 0===r?{}:r,o=this.instances.get(n);if(!o&&this.component&&(o=this.component.instanceFactory(this.container,{instanceIdentifier:(t=n,"[DEFAULT]"===t?void 0:t),options:i}),this.instances.set(n,o),this.invokeOnInitCallbacks(o,n),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,n,o)}catch(e){}return o||null},e.prototype.normalizeInstanceIdentifier=function(e){return void 0===e&&(e="[DEFAULT]"),this.component?this.component.multipleInstances?e:"[DEFAULT]":e},e.prototype.shouldAutoInitialize=function(){return!!this.component&&"EXPLICIT"!==this.component.instantiationMode},e}();
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
***************************************************************************** */function Xe(){for(var e=0,t=0,n=arguments.length;t<n;t++)e+=arguments[t].length;var r=Array(e),i=0;for(t=0;t<n;t++)for(var o=arguments[t],s=0,a=o.length;s<a;s++,i++)r[i]=o[s];return r}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ot{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const st=new it("@firebase/app"),at={"@firebase/app-exp":"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics-exp":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check-exp":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth-exp":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions-exp":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations-exp":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging-exp":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance-exp":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config-exp":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js","firebase-exp":"fire-js-all"},lt=new Map,ct=new Map;function ut(e,t){try{e.container.addComponent(t)}catch(n){st.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function ht(e){const t=e.name;if(ct.has(t))return st.debug(`There were multiple attempts to register component ${t}.`),!1;ct.set(t,e);for(const t of lt.values())ut(t,e);return!0}function dt(e,t){return e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gt(e="[DEFAULT]"){const t=lt.get(e);if(!t)throw pt.create("no-app",{appName:e});return t}function mt(e,t,n){var r;let i=null!==(r=at[e])&&void 0!==r?r:e;n&&(i+=`-${n}`);const o=i.match(/\s|\//),s=t.match(/\s|\//);if(o||s){const e=[`Unable to register library "${i}" with version "${t}":`];return o&&e.push(`library name "${i}" contains illegal characters (whitespace or "/")`),o&&s&&e.push("and"),s&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void st.warn(e.join(" "))}ht(new Ke(`${i}-version`,(()=>({library:i,version:t})),"VERSION"))}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qt(e,t){Tt(e.emulator,"Emulator should always be set here");const{url:n}=e.emulator;return t?`${n}${t.startsWith("/")?t.slice(1):t}`:n}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Lt(e,t,n,r,i={}){return Mt(e,i,(()=>{let i={},o={};r&&("GET"===t?o=r:i={body:JSON.stringify(r)});const s=Ue(Object.assign({key:e.config.apiKey},o)).slice(1),a=new(Ot.headers());return a.set("Content-Type","application/json"),a.set("X-Client-Version",e._getSdkClientVersion()),e.languageCode&&a.set("X-Firebase-Locale",e.languageCode),Ot.fetch()(Ft(e,e.config.apiHost,n,s),Object.assign({method:t,headers:a,referrerPolicy:"no-referrer"},i))}))}async function Mt(e,t,n){e._canInitEmulator=!1;const r=Object.assign(Object.assign({},At),t);try{const t=new zt(e),i=await Promise.race([n(),t.promise]);t.clearNetworkTimeout();const o=await i.json();if("needConfirmation"in o)throw Ut(e,"account-exists-with-different-credential",o);if(i.ok&&!("errorMessage"in o))return o;{const t=(i.ok?o.errorMessage:o.error.message).split(" : ")[0];if("FEDERATED_USER_ID_ALREADY_LINKED"===t)throw Ut(e,"credential-already-in-use",o);if("EMAIL_EXISTS"===t)throw Ut(e,"email-already-in-use",o);bt(e,r[t]||t.toLowerCase().replace(/[_\s]+/g,"-"))}}catch(t){if(t instanceof Ne)throw t;bt(e,"network-request-failed")}}function Ft(e,t,n,r){const i=`${t}${n}?${r}`;return e.config.emulator?qt(e.config,i):`${e.config.apiScheme}://${i}`}class zt{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise(((e,t)=>{this.timer=setTimeout((()=>t(xt(this.auth,"timeout"))),Dt.get())}))}clearNetworkTimeout(){clearTimeout(this.timer)}}function Ut(e,t,n){const r={appName:e.name};n.email&&(r.email=n.email),n.phoneNumber&&(r.phoneNumber=n.phoneNumber);const i=xt(e,t,r);return i.customData._tokenResponse=n,i}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kt(e){var t;const n=e.auth,r=await e.getIdToken(),i=await Ht(e,async function(e,t){return Lt(e,"POST","/v1/accounts:lookup",t)}(n,{idToken:r}));Ct(null==i?void 0:i.users.length,n,"internal-error");const o=i.users[0];e._notifyReloadListener(o);const s=(null===(t=o.providerUserInfo)||void 0===t?void 0:t.length)?o.providerUserInfo.map((e=>{var{providerId:t}=e,n=ue(e,["providerId"]);return{providerId:t,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}})):[];const a=(l=e.providerData,c=s,[...l.filter((e=>!c.some((t=>t.providerId===e.providerId)))),...c]);var l,c;const u=e.isAnonymous,h=!(e.email&&o.passwordHash||(null==a?void 0:a.length)),d=!!u&&h,p={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:a,metadata:new Gt(o.createdAt,o.lastLoginAt),isAnonymous:d};Object.assign(e,p)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function(e,t){const n=await Mt(e,{},(()=>{const n=Ue({grant_type:"refresh_token",refresh_token:t}).slice(1),{tokenApiHost:r,apiKey:i}=e.config,o=Ft(e,r,"/v1/token",`key=${i}`);return Ot.fetch()(o,{method:"POST",headers:{"X-Client-Version":e._getSdkClientVersion(),"Content-Type":"application/x-www-form-urlencoded"},body:n})}));return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}(e,t);this.updateTokensAndExpiration(n,r,Number(i))}updateTokensAndExpiration(e,t,n){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+1e3*n}static fromJSON(e,t){const{refreshToken:n,accessToken:r,expirationTime:i}=t,o=new Yt;return n&&(Ct("string"==typeof n,"internal-error",{appName:e}),o.refreshToken=n),r&&(Ct("string"==typeof r,"internal-error",{appName:e}),o.accessToken=r),i&&(Ct("number"==typeof i,"internal-error",{appName:e}),o.expirationTime=i),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new Yt,this.toJSON())}_performRefresh(){return It("not implemented")}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _n(e,t){return async function(e,t,n,r,i={}){const o=await Lt(e,t,n,r,i);return"mfaPendingCredential"in o&&bt(e,"multi-factor-auth-required",{serverResponse:o}),o}(e,"POST","/v1/accounts:signInWithIdp",function(e,t){return e.tenantId&&!t.tenantId?Object.assign(Object.assign({},t),{tenantId:e.tenantId}):t}(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Rn(e,{displayName:t,photoURL:n}){if(void 0===t&&void 0===n)return;const r=Ge(e),i={idToken:await r.getIdToken(),displayName:t,photoUrl:n,returnSecureToken:!0},o=await Ht(r,
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const rr=new Pt(3e4,6e4);function ir(){const e=Fn().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}function or(e){return new Promise(((t,n)=>{var r,i,o;function s(){ir(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{ir(),n(xt(e,"network-request-failed"))},timeout:rr.get()})}if(null===(i=null===(r=Fn().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=Fn().gapi)||void 0===o?void 0:o.load)){const t=`__${"iframefcb"}${Math.floor(1e6*Math.random())}`;return Fn()[t]=()=>{gapi.load?s():n(xt(e,"network-request-failed"))},nr(`https://apis.google.com/js/api.js?onload=${t}`)}s()}})).catch((e=>{throw sr=null,e}))}let sr=null;
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
const ar=new Pt(5e3,15e3),lr={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"}},cr=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function ur(e){const t=e.config;Ct(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?qt(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,r={apiKey:t.apiKey,appName:e.name,v:"9.0.0-beta.7"},i=cr.get(e.config.apiHost);i&&(r.eid=i);const o=e._getFrameworks();return o.length&&(r.fw=o.join(",")),`${n}?${Ue(r).slice(1)}`}async function hr(e){const t=await function(e){return sr=sr||or(e),sr}(e),n=Fn().gapi;return Ct(n,e,"internal-error"),t.open({where:document.body,url:ur(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:lr,dontclear:!0},(t=>new Promise((async(n,r)=>{await t.restyle({setHideOnLeave:!1});const i=xt(e,"network-request-failed"),o=Fn().setTimeout((()=>{r(i)}),ar.get());function s(){Fn().clearTimeout(o),n(t)}t.ping(s).then(s,(()=>{r(i)}))}))))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dr extends qn{constructor(){super(window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}dr.type="SESSION";const pr=dr,fr={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"};
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gr{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch(e){}}}function mr(e,t,n,r=500,i=600){const o=Math.min((window.screen.availHeight-i)/2,0).toString(),s=Math.min((window.screen.availWidth-r)/2,0).toString();let a="";const l=Object.assign(Object.assign({},fr),{width:r.toString(),height:i.toString(),top:o,left:s}),c=Te().toLowerCase();n&&(a=sn(c)?"_blank":n),rn(c)&&(t=t||"http://localhost",l.scrollbars="yes");const u=Object.entries(l).reduce(((e,[t,n])=>`${e}${t}=${n},`),"");if(function(e=Te()){var t;return hn(e)&&!!(null===(t=window.navigator)||void 0===t?void 0:t.standalone)}(c)&&"_self"!==a)return function(e,t){const n=document.createElement("a");n.href=e,n.target=t;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(r)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t||"",a),new gr(null);const h=window.open(t||"",a,u);Ct(h,e,"popup-blocked");try{h.focus()}catch(e){}return new gr(h)}function vr(e,t){return t?Et(t):(Ct(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
return async function(e,t,n=!1){const r="signIn",i=await Nn(e,r,t),o=await Sn._fromIdTokenResponse(e,r,i);return n||await e._updateCurrentUser(o.user),o}(e.auth,new yr(e),e.bypassAuthState)}function wr(e){const{auth:t,user:n}=e;return Ct(n,t,"internal-error"),
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
async function(e,t,n=!1){const{auth:r}=e,i="reauthenticate";try{const o=await Ht(e,Nn(r,i,t,e),n);Ct(o.idToken,r,"internal-error");const s=Vt(o.idToken);Ct(s,r,"internal-error");const{sub:a}=s;return Ct(e.uid===a,r,"user-mismatch"),Sn._forOperation(e,i,o)}catch(e){throw"auth/user-not-found"===(null==e?void 0:e.code)&&bt(r,"user-mismatch"),e}}(n,new yr(e),e.bypassAuthState)}async function br(e){const{auth:t,user:n}=e;return Ct(n,t,"internal-error"),async function(e,t,n=!1){const r=await Ht(e,t._linkToIdToken(e.auth,await e.getIdToken()),n);return Sn._forOperation(e,"link",r)}(n,new yr(e),e.bypassAuthState)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sr(e,t,n,r,i,o){Ct(e.config.authDomain,e,"auth-domain-config-required"),Ct(e.config.apiKey,e,"invalid-api-key");const s={apiKey:e.config.apiKey,appName:e.name,authType:n,redirectUrl:r,v:"9.0.0-beta.7",eventId:i};if(t instanceof bn){t.setDefaultLanguage(e.languageCode),s.providerId=t.providerId||"",Fe(t.getCustomParameters())||(s.customParameters=JSON.stringify(t.getCustomParameters()));for(const[e,t]of Object.entries(o||{}))s[e]=t}if(t instanceof xn){const e=t.getScopes().filter((e=>""!==e));e.length>0&&(s.scopes=e.join(","))}e.tenantId&&(s.tid=e.tenantId);const a=s;for(const e of Object.keys(a))void 0===a[e]&&delete a[e];return`${function({config:e}){if(!e.emulator)return`https://${e.authDomain}/__/auth/handler`;return qt(e,"emulator/auth/handler")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mi{constructor(){this.counters_={}}incrementCounter(e,t=1){Le(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return ke(this.counters_)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vi={},yi={};function _i(e){const t=e.toString();return vi[t]||(vi[t]=new mi),vi[t]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eo{constructor(e,t,n,r,i=null){this.isReverse_=r,this.resultGenerator_=i,this.nodeStack_=[];let o=1;for(;!e.isEmpty();)if(e=e,o=t?n(e.key,t):1,r&&(o*=-1),o<0)e=this.isReverse_?e.left:e.right;else{if(0===o){this.nodeStack_.push(e);break}this.nodeStack_.push(e),e=this.isReverse_?e.right:e.left}}getNext(){if(0===this.nodeStack_.length)return null;let e,t=this.nodeStack_.pop();if(e=this.resultGenerator_?this.resultGenerator_(t.key,t.value):{key:t.key,value:t.value},this.isReverse_)for(t=t.left;!t.isEmpty();)this.nodeStack_.push(t),t=t.right;else for(t=t.right;!t.isEmpty();)this.nodeStack_.push(t),t=t.left;return e}hasNext(){return this.nodeStack_.length>0}peek(){if(0===this.nodeStack_.length)return null;const e=this.nodeStack_[this.nodeStack_.length-1];return this.resultGenerator_?this.resultGenerator_(e.key,e.value):{key:e.key,value:e.value}}}class to{constructor(e,t,n,r,i){this.key=e,this.value=t,this.color=null!=n?n:to.RED,this.left=null!=r?r:no.EMPTY_NODE,this.right=null!=i?i:no.EMPTY_NODE}copy(e,t,n,r,i){return new to(null!=e?e:this.key,null!=t?t:this.value,null!=n?n:this.color,null!=r?r:this.left,null!=i?i:this.right)}count(){return this.left.count()+1+this.right.count()}isEmpty(){return!1}inorderTraversal(e){return this.left.inorderTraversal(e)||!!e(this.key,this.value)||this.right.inorderTraversal(e)}reverseTraversal(e){return this.right.reverseTraversal(e)||e(this.key,this.value)||this.left.reverseTraversal(e)}min_(){return this.left.isEmpty()?this:this.left.min_()}minKey(){return this.min_().key}maxKey(){return this.right.isEmpty()?this.key:this.right.maxKey()}insert(e,t,n){let r=this;const i=n(e,r.key);return r=i<0?r.copy(null,null,null,r.left.insert(e,t,n),null):0===i?r.copy(null,t,null,null,null):r.copy(null,null,null,null,r.right.insert(e,t,n)),r.fixUp_()}removeMin_(){if(this.left.isEmpty())return no.EMPTY_NODE;let e=this;return e.left.isRed_()||e.left.left.isRed_()||(e=e.moveRedLeft_()),e=e.copy(null,null,null,e.left.removeMin_(),null),e.fixUp_()}remove(e,t){let n,r;if(n=this,t(e,n.key)<0)n.left.isEmpty()||n.left.isRed_()||n.left.left.isRed_()||(n=n.moveRedLeft_()),n=n.copy(null,null,null,n.left.remove(e,t),null);else{if(n.left.isRed_()&&(n=n.rotateRight_()),n.right.isEmpty()||n.right.isRed_()||n.right.left.isRed_()||(n=n.moveRedRight_()),0===t(e,n.key)){if(n.right.isEmpty())return no.EMPTY_NODE;r=n.right.min_(),n=n.copy(r.key,r.value,null,null,n.right.removeMin_())}n=n.copy(null,null,null,null,n.right.remove(e,t))}return n.fixUp_()}isRed_(){return this.color}fixUp_(){let e=this;return e.right.isRed_()&&!e.left.isRed_()&&(e=e.rotateLeft_()),e.left.isRed_()&&e.left.left.isRed_()&&(e=e.rotateRight_()),e.left.isRed_()&&e.right.isRed_()&&(e=e.colorFlip_()),e}moveRedLeft_(){let e=this.colorFlip_();return e.right.left.isRed_()&&(e=e.copy(null,null,null,null,e.right.rotateRight_()),e=e.rotateLeft_(),e=e.colorFlip_()),e}moveRedRight_(){let e=this.colorFlip_();return e.left.left.isRed_()&&(e=e.rotateRight_(),e=e.colorFlip_()),e}rotateLeft_(){const e=this.copy(null,null,to.RED,null,this.right.left);return this.right.copy(null,null,this.color,e,null)}rotateRight_(){const e=this.copy(null,null,to.RED,this.left.right,null);return this.left.copy(null,null,this.color,null,e)}colorFlip_(){const e=this.left.copy(null,null,!this.left.color,null,null),t=this.right.copy(null,null,!this.right.color,null,null);return this.copy(null,null,!this.color,e,t)}checkMaxDepth_(){const e=this.check_();return Math.pow(2,e)<=this.count()+1}check_(){if(this.isRed_()&&this.left.isRed_())throw new Error("Red node has red child("+this.key+","+this.value+")");if(this.right.isRed_())throw new Error("Right child of ("+this.key+","+this.value+") is red");const e=this.left.check_();if(e!==this.right.check_())throw new Error("Black depths differ");return e+(this.isRed_()?0:1)}}to.RED=!0,to.BLACK=!1;class no{constructor(e,t=no.EMPTY_NODE){this.comparator_=e,this.root_=t}insert(e,t){return new no(this.comparator_,this.root_.insert(e,t,this.comparator_).copy(null,null,to.BLACK,null,null))}remove(e){return new no(this.comparator_,this.root_.remove(e,this.comparator_).copy(null,null,to.BLACK,null,null))}get(e){let t,n=this.root_;for(;!n.isEmpty();){if(t=this.comparator_(e,n.key),0===t)return n.value;t<0?n=n.left:t>0&&(n=n.right)}return null}getPredecessorKey(e){let t,n=this.root_,r=null;for(;!n.isEmpty();){if(t=this.comparator_(e,n.key),0===t){if(n.left.isEmpty())return r?r.key:null;for(n=n.left;!n.right.isEmpty();)n=n.right;return n.key}t<0?n=n.left:t>0&&(r=n,n=n.right)}throw new Error("Attempted to find predecessor key for a nonexistent key.  What gives?")}isEmpty(){return this.root_.isEmpty()}count(){return this.root_.count()}minKey(){return this.root_.minKey()}maxKey(){return this.root_.maxKey()}inorderTraversal(e){return this.root_.inorderTraversal(e)}reverseTraversal(e){return this.root_.reverseTraversal(e)}getIterator(e){return new eo(this.root_,null,this.comparator_,!1,e)}getIteratorFrom(e,t){return new eo(this.root_,e,this.comparator_,!1,t)}getReverseIteratorFrom(e,t){return new eo(this.root_,e,this.comparator_,!0,t)}getReverseIterator(e){return new eo(this.root_,null,this.comparator_,!0,e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function ro(e,t){return Xr(e.name,t.name)}function io(e,t){return Xr(e,t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let oo;no.EMPTY_NODE=new class{copy(e,t,n,r,i){return this}insert(e,t,n){return new to(e,t,null)}remove(e,t){return this}count(){return 0}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}check_(){return 0}isRed_(){return!1}};const so=function(e){return"number"==typeof e?"number:"+oi(e):"string:"+e},ao=function(e){if(e.isLeafNode()){const t=e.val();ye("string"==typeof t||"number"==typeof t||"object"==typeof t&&Le(t,".sv"),"Priority must be a string or number.")}else ye(e===oo||e.isEmpty(),"priority of unexpected type.");ye(e===oo||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
let lo,co,uo;class ho{constructor(e,t=ho.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=t,this.lazyHash_=null,ye(void 0!==this.value_&&null!==this.value_,"LeafNode shouldn't be created with null/undefined value."),ao(this.priorityNode_)}static set __childrenNodeConstructor(e){lo=e}static get __childrenNodeConstructor(){return lo}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new ho(this.value_,e)}getImmediateChild(e){return".priority"===e?this.priorityNode_:ho.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return Fi(e)?this:".priority"===Pi(e)?this.priorityNode_:ho.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,t){return null}updateImmediateChild(e,t){return".priority"===e?this.updatePriority(t):t.isEmpty()&&".priority"!==e?this:ho.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,t).updatePriority(this.priorityNode_)}updateChild(e,t){const n=Pi(e);return null===n?t:t.isEmpty()&&".priority"!==n?this:(ye(".priority"!==n||1===qi(e),".priority must be the last token in a path"),this.updateImmediateChild(n,ho.__childrenNodeConstructor.EMPTY_NODE.updateChild(Oi(e),t)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,t){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(null===this.lazyHash_){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+so(this.priorityNode_.val())+":");const t=typeof this.value_;e+=t+":",e+="number"===t?oi(this.value_):this.value_,this.lazyHash_=Ur(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===ho.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof ho.__childrenNodeConstructor?-1:(ye(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const t=typeof e.value_,n=typeof this.value_,r=ho.VALUE_TYPE_ORDER.indexOf(t),i=ho.VALUE_TYPE_ORDER.indexOf(n);return ye(r>=0,"Unknown leaf type: "+t),ye(i>=0,"Unknown leaf type: "+n),r===i?"object"===n?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:i-r}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}return!1}}ho.VALUE_TYPE_ORDER=["object","boolean","number","string"];const po=new class extends Ji{compare(e,t){const n=e.node.getPriority(),r=t.node.getPriority(),i=n.compareTo(r);return 0===i?Xr(e.name,t.name):i}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return Yi.MIN}maxPost(){return new Yi(Zr,new ho("[PRIORITY-POST]",uo))}makePost(e,t){const n=co(e);return new Yi(t,new ho("[PRIORITY-POST]",n))}toString(){return".priority"}},fo=Math.log(2);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class go{constructor(e){var t;this.count=(t=e+1,parseInt(Math.log(t)/fo,10)),this.current_=this.count-1;const n=(r=this.count,parseInt(Array(r+1).join("1"),2));var r;this.bits_=e+1&n}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const mo=function(e,t,n,r){e.sort(t);const i=function(t,r){const o=r-t;let s,a;if(0===o)return null;if(1===o)return s=e[t],a=n?n(s):s,new to(a,s.node,to.BLACK,null,null);{const l=parseInt(o/2,10)+t,c=i(t,l),u=i(l+1,r);return s=e[l],a=n?n(s):s,new to(a,s.node,to.BLACK,c,u)}},o=function(t){let r=null,o=null,s=e.length;const a=function(t,r){const o=s-t,a=s;s-=t;const c=i(o+1,a),u=e[o],h=n?n(u):u;l(new to(h,u.node,r,null,c))},l=function(e){r?(r.left=e,r=e):(o=e,r=e)};for(let e=0;e<t.count;++e){const n=t.nextBitIsOne(),r=Math.pow(2,t.count-(e+1));n?a(r,to.BLACK):(a(r,to.BLACK),a(r,to.RED))}return o}(new go(e.length));return new no(r||t,o)};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let vo;const yo={};class _o{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return ye(yo&&po,"ChildrenNode.ts has not been loaded"),vo=vo||new _o({".priority":yo},{".priority":po}),vo}get(e){const t=Me(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof no?t:null}hasIndex(e){return Le(this.indexSet_,e.toString())}addIndex(e,t){ye(e!==Xi,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let r=!1;const i=t.getIterator(Yi.Wrap);let o,s=i.getNext();for(;s;)r=r||e.isDefinedOn(s.node),n.push(s),s=i.getNext();o=r?mo(n,e.getCompare()):yo;const a=e.toString(),l=Object.assign({},this.indexSet_);l[a]=e;const c=Object.assign({},this.indexes_);return c[a]=o,new _o(c,l)}addToIndexes(e,t){const n=ze(this.indexes_,((n,r)=>{const i=Me(this.indexSet_,r);if(ye(i,"Missing index implementation for "+r),n===yo){if(i.isDefinedOn(e.node)){const n=[],r=t.getIterator(Yi.Wrap);let o=r.getNext();for(;o;)o.name!==e.name&&n.push(o),o=r.getNext();return n.push(e),mo(n,i.getCompare())}return yo}{const r=t.get(e.name);let i=n;return r&&(i=i.remove(new Yi(e.name,r))),i.insert(e,e.node)}}));return new _o(n,this.indexSet_)}removeFromIndexes(e,t){const n=ze(this.indexes_,(n=>{if(n===yo)return n;{const r=t.get(e.name);return r?n.remove(new Yi(e.name,r)):n}}));return new _o(n,this.indexSet_)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let wo;class bo{constructor(e,t,n){this.children_=e,this.priorityNode_=t,this.indexMap_=n,this.lazyHash_=null,this.priorityNode_&&ao(this.priorityNode_),this.children_.isEmpty()&&ye(!this.priorityNode_||this.priorityNode_.isEmpty(),"An empty node cannot have a priority")}static get EMPTY_NODE(){return wo||(wo=new bo(new no(io),null,_o.Default))}isLeafNode(){return!1}getPriority(){return this.priorityNode_||wo}updatePriority(e){return this.children_.isEmpty()?this:new bo(this.children_,e,this.indexMap_)}getImmediateChild(e){if(".priority"===e)return this.getPriority();{const t=this.children_.get(e);return null===t?wo:t}}getChild(e){const t=Pi(e);return null===t?this:this.getImmediateChild(t).getChild(Oi(e))}hasChild(e){return null!==this.children_.get(e)}updateImmediateChild(e,t){if(ye(t,"We should always be passing snapshot nodes"),".priority"===e)return this.updatePriority(t);{const n=new Yi(e,t);let r,i;t.isEmpty()?(r=this.children_.remove(e),i=this.indexMap_.removeFromIndexes(n,this.children_)):(r=this.children_.insert(e,t),i=this.indexMap_.addToIndexes(n,this.children_));const o=r.isEmpty()?wo:this.priorityNode_;return new bo(r,o,i)}}updateChild(e,t){const n=Pi(e);if(null===n)return t;{ye(".priority"!==Pi(e)||1===qi(e),".priority must be the last token in a path");const r=this.getImmediateChild(n).updateChild(Oi(e),t);return this.updateImmediateChild(n,r)}}isEmpty(){return this.children_.isEmpty()}numChildren(){return this.children_.count()}val(e){if(this.isEmpty())return null;const t={};let n=0,r=0,i=!0;if(this.forEachChild(po,((o,s)=>{t[o]=s.val(e),n++,i&&bo.INTEGER_REGEXP_.test(o)?r=Math.max(r,Number(o)):i=!1})),!e&&i&&r<2*n){const e=[];for(const n in t)e[n]=t[n];return e}return e&&!this.getPriority().isEmpty()&&(t[".priority"]=this.getPriority().val()),t}hash(){if(null===this.lazyHash_){let e="";this.getPriority().isEmpty()||(e+="priority:"+so(this.getPriority().val())+":"),this.forEachChild(po,((t,n)=>{const r=n.hash();""!==r&&(e+=":"+t+":"+r)})),this.lazyHash_=""===e?"":Ur(e)}return this.lazyHash_}getPredecessorChildName(e,t,n){const r=this.resolveIndex_(n);if(r){const n=r.getPredecessorKey(new Yi(e,t));return n?n.name:null}return this.children_.getPredecessorKey(e)}getFirstChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.minKey();return e&&e.name}return this.children_.minKey()}getFirstChild(e){const t=this.getFirstChildName(e);return t?new Yi(t,this.children_.get(t)):null}getLastChildName(e){const t=this.resolveIndex_(e);if(t){const e=t.maxKey();return e&&e.name}return this.children_.maxKey()}getLastChild(e){const t=this.getLastChildName(e);return t?new Yi(t,this.children_.get(t)):null}forEachChild(e,t){const n=this.resolveIndex_(e);return n?n.inorderTraversal((e=>t(e.name,e.node))):this.children_.inorderTraversal(t)}getIterator(e){return this.getIteratorFrom(e.minPost(),e)}getIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getIteratorFrom(e,(e=>e));{const n=this.children_.getIteratorFrom(e.name,Yi.Wrap);let r=n.peek();for(;null!=r&&t.compare(r,e)<0;)n.getNext(),r=n.peek();return n}}getReverseIterator(e){return this.getReverseIteratorFrom(e.maxPost(),e)}getReverseIteratorFrom(e,t){const n=this.resolveIndex_(t);if(n)return n.getReverseIteratorFrom(e,(e=>e));{const n=this.children_.getReverseIteratorFrom(e.name,Yi.Wrap);let r=n.peek();for(;null!=r&&t.compare(r,e)>0;)n.getNext(),r=n.peek();return n}}compareTo(e){return this.isEmpty()?e.isEmpty()?0:-1:e.isLeafNode()||e.isEmpty()?1:e===xo?-1:0}withIndex(e){if(e===Xi||this.indexMap_.hasIndex(e))return this;{const t=this.indexMap_.addIndex(e,this.children_);return new bo(this.children_,this.priorityNode_,t)}}isIndexed(e){return e===Xi||this.indexMap_.hasIndex(e)}equals(e){if(e===this)return!0;if(e.isLeafNode())return!1;{const t=e;if(this.getPriority().equals(t.getPriority())){if(this.children_.count()===t.children_.count()){const e=this.getIterator(po),n=t.getIterator(po);let r=e.getNext(),i=n.getNext();for(;r&&i;){if(r.name!==i.name||!r.node.equals(i.node))return!1;r=e.getNext(),i=n.getNext()}return null===r&&null===i}return!1}return!1}}resolveIndex_(e){return e===Xi?null:this.indexMap_.get(e.toString())}}bo.INTEGER_REGEXP_=/^(0|[1-9]\d*)$/;const xo=new class extends bo{constructor(){super(new no(io),bo.EMPTY_NODE,_o.Default)}compareTo(e){return e===this?0:1}equals(e){return e===this}getPriority(){return this}getImmediateChild(e){return bo.EMPTY_NODE}isEmpty(){return!1}};Object.defineProperties(Yi,{MIN:{value:new Yi(Qr,bo.EMPTY_NODE)},MAX:{value:new Yi(Zr,xo)}}),Zi.__EMPTY_NODE=bo.EMPTY_NODE,ho.__childrenNodeConstructor=bo,oo=xo,function(e){uo=e}(xo);function ko(e,t=null){if(null===e)return bo.EMPTY_NODE;if("object"==typeof e&&".priority"in e&&(t=e[".priority"]),ye(null===t||"string"==typeof t||"number"==typeof t||"object"==typeof t&&".sv"in t,"Invalid priority type found: "+typeof t),"object"==typeof e&&".value"in e&&null!==e[".value"]&&(e=e[".value"]),"object"!=typeof e||".sv"in e){return new ho(e,ko(t))}if(e instanceof Array){let n=bo.EMPTY_NODE;return ii(e,((t,r)=>{if(Le(e,t)&&"."!==t.substring(0,1)){const e=ko(r);!e.isLeafNode()&&e.isEmpty()||(n=n.updateImmediateChild(t,e))}})),n.updatePriority(ko(t))}{const n=[];let r=!1;if(ii(e,((e,t)=>{if("."!==e.substring(0,1)){const i=ko(t);i.isEmpty()||(r=r||!i.getPriority().isEmpty(),n.push(new Yi(e,i)))}})),0===n.length)return bo.EMPTY_NODE;const i=mo(n,ro,(e=>e.name),io);if(r){const e=mo(n,po.getCompare());return new bo(i,ko(t),new _o({".priority":e},{".priority":po}))}return new bo(i,ko(t),_o.Default)}}!function(e){co=e}(ko);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Co extends Ji{constructor(e){super(),this.indexPath_=e,ye(!Fi(e)&&".priority"!==Pi(e),"Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),r=this.extractChild(t.node),i=n.compareTo(r);return 0===i?Xr(e.name,t.name):i}makePost(e,t){const n=ko(e),r=bo.EMPTY_NODE.updateChild(this.indexPath_,n);return new Yi(t,r)}maxPost(){const e=bo.EMPTY_NODE.updateChild(this.indexPath_,xo);return new Yi(Zr,e)}toString(){return Di(this.indexPath_,0).join("/")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Io=new class extends Ji{compare(e,t){const n=e.node.compareTo(t.node);return 0===n?Xr(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return Yi.MIN}maxPost(){return Yi.MAX}makePost(e,t){const n=ko(e);return new Yi(t,n)}toString(){return".value"}},To="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",So=function(){let e=0;const t=[];return function(n){const r=n===e;let i;e=n;const o=new Array(8);for(i=7;i>=0;i--)o[i]=To.charAt(n%64),n=Math.floor(n/64);ye(0===n,"Cannot push at time == 0");let s=o.join("");if(r){for(i=11;i>=0&&63===t[i];i--)t[i]=0;t[i]++}else for(i=0;i<12;i++)t[i]=Math.floor(64*Math.random());for(i=0;i<12;i++)s+=To.charAt(t[i]);return ye(20===s.length,"nextPushId: Length should be 20."),s}}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Po{constructor(e){this.index_=e}updateChild(e,t,n,r,i,o){ye(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const s=e.getImmediateChild(t);return s.getChild(r).equals(n.getChild(r))&&s.isEmpty()===n.isEmpty()?e:(null!=o&&(n.isEmpty()?e.hasChild(t)?o.trackChildChange(No(t,s)):ye(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):s.isEmpty()?o.trackChildChange($o(t,n)):o.trackChildChange(Ro(t,n,s))),e.isLeafNode()&&n.isEmpty()?e:e.updateImmediateChild(t,n).withIndex(this.index_))}updateFullNode(e,t,n){return null!=n&&(e.isLeafNode()||e.forEachChild(po,((e,r)=>{t.hasChild(e)||n.trackChildChange(No(e,r))})),t.isLeafNode()||t.forEachChild(po,((t,r)=>{if(e.hasChild(t)){const i=e.getImmediateChild(t);i.equals(r)||n.trackChildChange(Ro(t,r,i))}else n.trackChildChange($o(t,r))}))),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?bo.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qo{constructor(e){this.indexedFilter_=new Po(e.getIndex()),this.index_=e.getIndex(),this.startPost_=qo.getStartPost_(e),this.endPost_=qo.getEndPost_(e)}getStartPost(){return this.startPost_}getEndPost(){return this.endPost_}matches(e){return this.index_.compare(this.getStartPost(),e)<=0&&this.index_.compare(e,this.getEndPost())<=0}updateChild(e,t,n,r,i,o){return this.matches(new Yi(t,n))||(n=bo.EMPTY_NODE),this.indexedFilter_.updateChild(e,t,n,r,i,o)}updateFullNode(e,t,n){t.isLeafNode()&&(t=bo.EMPTY_NODE);let r=t.withIndex(this.index_);r=r.updatePriority(bo.EMPTY_NODE);const i=this;return t.forEachChild(po,((e,t)=>{i.matches(new Yi(e,t))||(r=r.updateImmediateChild(e,bo.EMPTY_NODE))})),this.indexedFilter_.updateFullNode(e,r,n)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.indexedFilter_}getIndex(){return this.index_}static getStartPost_(e){if(e.hasStart()){const t=e.getIndexStartName();return e.getIndex().makePost(e.getIndexStartValue(),t)}return e.getIndex().minPost()}static getEndPost_(e){if(e.hasEnd()){const t=e.getIndexEndName();return e.getIndex().makePost(e.getIndexEndValue(),t)}return e.getIndex().maxPost()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oo{constructor(e){this.rangedFilter_=new qo(e),this.index_=e.getIndex(),this.limit_=e.getLimit(),this.reverse_=!e.isViewFromLeft()}updateChild(e,t,n,r,i,o){return this.rangedFilter_.matches(new Yi(t,n))||(n=bo.EMPTY_NODE),e.getImmediateChild(t).equals(n)?e:e.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(e,t,n,r,i,o):this.fullLimitUpdateChild_(e,t,n,i,o)}updateFullNode(e,t,n){let r;if(t.isLeafNode()||t.isEmpty())r=bo.EMPTY_NODE.withIndex(this.index_);else if(2*this.limit_<t.numChildren()&&t.isIndexed(this.index_)){let e;r=bo.EMPTY_NODE.withIndex(this.index_),e=this.reverse_?t.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):t.getIteratorFrom(this.rangedFilter_.getStartPost(),this.index_);let n=0;for(;e.hasNext()&&n<this.limit_;){const t=e.getNext();let i;if(i=this.reverse_?this.index_.compare(this.rangedFilter_.getStartPost(),t)<=0:this.index_.compare(t,this.rangedFilter_.getEndPost())<=0,!i)break;r=r.updateImmediateChild(t.name,t.node),n++}}else{let e,n,i,o;if(r=t.withIndex(this.index_),r=r.updatePriority(bo.EMPTY_NODE),this.reverse_){o=r.getReverseIterator(this.index_),e=this.rangedFilter_.getEndPost(),n=this.rangedFilter_.getStartPost();const t=this.index_.getCompare();i=(e,n)=>t(n,e)}else o=r.getIterator(this.index_),e=this.rangedFilter_.getStartPost(),n=this.rangedFilter_.getEndPost(),i=this.index_.getCompare();let s=0,a=!1;for(;o.hasNext();){const t=o.getNext();!a&&i(e,t)<=0&&(a=!0);a&&s<this.limit_&&i(t,n)<=0?s++:r=r.updateImmediateChild(t.name,bo.EMPTY_NODE)}}return this.rangedFilter_.getIndexedFilter().updateFullNode(e,r,n)}updatePriority(e,t){return e}filtersNodes(){return!0}getIndexedFilter(){return this.rangedFilter_.getIndexedFilter()}getIndex(){return this.index_}fullLimitUpdateChild_(e,t,n,r,i){let o;if(this.reverse_){const e=this.index_.getCompare();o=(t,n)=>e(n,t)}else o=this.index_.getCompare();const s=e;ye(s.numChildren()===this.limit_,"");const a=new Yi(t,n),l=this.reverse_?s.getFirstChild(this.index_):s.getLastChild(this.index_),c=this.rangedFilter_.matches(a);if(s.hasChild(t)){const e=s.getImmediateChild(t);let u=r.getChildAfterChild(this.index_,l,this.reverse_);for(;null!=u&&(u.name===t||s.hasChild(u.name));)u=r.getChildAfterChild(this.index_,u,this.reverse_);const h=null==u?1:o(u,a);if(c&&!n.isEmpty()&&h>=0)return null!=i&&i.trackChildChange(Ro(t,n,e)),s.updateImmediateChild(t,n);{null!=i&&i.trackChildChange(No(t,e));const n=s.updateImmediateChild(t,bo.EMPTY_NODE);return null!=u&&this.rangedFilter_.matches(u)?(null!=i&&i.trackChildChange($o(u.name,u.node)),n.updateImmediateChild(u.name,u.node)):n}}return n.isEmpty()?e:c&&o(l,a)>=0?(null!=i&&(i.trackChildChange(No(l.name,l.node)),i.trackChildChange($o(t,n))),s.updateImmediateChild(t,n).updateImmediateChild(l.name,bo.EMPTY_NODE)):e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mo extends Si{constructor(e,t,n,r){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=r,this.log_=Br("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(ye(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,r){const i=e._path.toString();this.log_("Listen called for "+i+" "+e._queryIdentifier);const o=Mo.getListenId_(e,n),s={};this.listens_[o]=s;const a=Do(e._queryParams);this.restRequest_(i+".json",a,((e,t)=>{let a=t;if(404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(i,a,!1,n),Me(this.listens_,o)===s){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",r(t,null)}}))}unlisten(e,t){const n=Mo.getListenId_(e,t);delete this.listens_[n]}get(e){const t=Do(e._queryParams),n=e._path.toString(),r=new Ie;return this.restRequest_(n+".json",t,((e,t)=>{let i=t;404===e&&(i=null,e=null),null===e?(this.onDataUpdate_(n,i,!1,null),r.resolve(i)):r.reject(new Error(i))})),r.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([r,i])=>{r&&r.accessToken&&(t.auth=r.accessToken),i&&i.token&&(t.ac=i.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+Ue(t);this.log_("Sending REST request for "+o);const s=new XMLHttpRequest;s.onreadystatechange=()=>{if(n&&4===s.readyState){this.log_("REST Response for "+o+" received. status:",s.status,"response:",s.responseText);let e=null;if(s.status>=200&&s.status<300){try{e=Oe(s.responseText)}catch(e){Yr("Failed to parse JSON response for "+o+": "+s.responseText)}n(null,e)}else 401!==s.status&&404!==s.status&&Yr("Got unsuccessful REST response for "+o+" Status: "+s.status),n(s.status);n=null}},s.open("GET",o,!0),s.send()}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fo{constructor(){this.rootNode_=bo.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zo(){return{value:null,children:new Map}}function Uo(e,t,n){if(Fi(t))e.value=n,e.children.clear();else if(null!==e.value)e.value=e.value.updateChild(t,n);else{const r=Pi(t);e.children.has(r)||e.children.set(r,zo());Uo(e.children.get(r),t=Oi(t),n)}}function jo(e,t,n){null!==e.value?n(t,e.value):function(e,t){e.children.forEach(((e,n)=>{t(n,e)}))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,r)=>{jo(r,new Ni(t.toString()+"/"+e),n)}))}class Wo{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&ii(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vo{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Wo(e);const n=1e4+2e4*Math.random();ci(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;ii(e,((e,r)=>{r>0&&Le(this.statsToReport_,e)&&(t[e]=r,n=!0)})),n&&this.server_.reportStats(t),ci(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ho;function Bo(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */!function(e){e[e.OVERWRITE=0]="OVERWRITE",e[e.MERGE=1]="MERGE",e[e.ACK_USER_WRITE=2]="ACK_USER_WRITE",e[e.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"}(Ho||(Ho={}));class Go{constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=Ho.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}operationForChild(e){if(Fi(this.path)){if(null!=this.affectedTree.value)return ye(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Ni(e));return new Go(Ri(),t,this.revert)}}return ye(Pi(this.path)===e,"operationForChild called for unrelated child."),new Go(Oi(this.path),this.affectedTree,this.revert)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ko{constructor(e,t){this.source=e,this.path=t,this.type=Ho.LISTEN_COMPLETE}operationForChild(e){return Fi(this.path)?new Ko(this.source,Ri()):new Ko(this.source,Oi(this.path))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yo{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Ho.OVERWRITE}operationForChild(e){return Fi(this.path)?new Yo(this.source,Ri(),this.snap.getImmediateChild(e)):new Yo(this.source,Oi(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jo{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Ho.MERGE}operationForChild(e){if(Fi(this.path)){const t=this.children.subtree(new Ni(e));return t.isEmpty()?null:t.value?new Yo(this.source,Ri(),t.value):new Jo(this.source,Ri(),t)}return ye(Pi(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Jo(this.source,Oi(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qo{constructor(e,t,n){this.node_=e,this.fullyInitialized_=t,this.filtered_=n}isFullyInitialized(){return this.fullyInitialized_}isFiltered(){return this.filtered_}isCompleteForPath(e){if(Fi(e))return this.isFullyInitialized()&&!this.filtered_;const t=Pi(e);return this.isCompleteForChild(t)}isCompleteForChild(e){return this.isFullyInitialized()&&!this.filtered_||this.node_.hasChild(e)}getNode(){return this.node_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zo{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Xo(e,t,n,r,i,o){const s=r.filter((e=>e.type===n));s.sort(((t,n)=>function(e,t,n){if(null==t.childName||null==n.childName)throw _e("Should only compare child_ events.");const r=new Yi(t.childName,t.snapshotNode),i=new Yi(n.childName,n.snapshotNode);return e.index_.compare(r,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),s.forEach((n=>{const r=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,o);i.forEach((i=>{i.respondsTo(n.type)&&t.push(i.createEvent(r,e.query_))}))}))}function es(e,t){return{eventCache:e,serverCache:t}}function ts(e,t,n,r){return es(new Qo(t,n,r),e.serverCache)}function ns(e,t,n,r){return es(e.eventCache,new Qo(t,n,r))}function rs(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function is(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let os;class ss{constructor(e,t=(()=>(os||(os=new no(ei)),os))()){this.value=e,this.children=t}static fromObject(e){let t=new ss(null);return ii(e,((e,n)=>{t=t.set(new Ni(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:Ri(),value:this.value};if(Fi(e))return null;{const n=Pi(e),r=this.children.get(n);if(null!==r){const i=r.findRootMostMatchingPathAndValue(Oi(e),t);if(null!=i){return{path:Mi(new Ni(n),i.path),value:i.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Fi(e))return this;{const t=Pi(e),n=this.children.get(t);return null!==n?n.subtree(Oi(e)):new ss(null)}}set(e,t){if(Fi(e))return new ss(t,this.children);{const n=Pi(e),r=(this.children.get(n)||new ss(null)).set(Oi(e),t),i=this.children.insert(n,r);return new ss(this.value,i)}}remove(e){if(Fi(e))return this.children.isEmpty()?new ss(null):new ss(null,this.children);{const t=Pi(e),n=this.children.get(t);if(n){const r=n.remove(Oi(e));let i;return i=r.isEmpty()?this.children.remove(t):this.children.insert(t,r),null===this.value&&i.isEmpty()?new ss(null):new ss(this.value,i)}return this}}get(e){if(Fi(e))return this.value;{const t=Pi(e),n=this.children.get(t);return n?n.get(Oi(e)):null}}setTree(e,t){if(Fi(e))return t;{const n=Pi(e),r=(this.children.get(n)||new ss(null)).setTree(Oi(e),t);let i;return i=r.isEmpty()?this.children.remove(n):this.children.insert(n,r),new ss(this.value,i)}}fold(e){return this.fold_(Ri(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((r,i)=>{n[r]=i.fold_(Mi(e,r),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,Ri(),t)}findOnPath_(e,t,n){const r=!!this.value&&n(t,this.value);if(r)return r;if(Fi(e))return null;{const r=Pi(e),i=this.children.get(r);return i?i.findOnPath_(Oi(e),Mi(t,r),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,Ri(),t)}foreachOnPath_(e,t,n){if(Fi(e))return this;{this.value&&n(t,this.value);const r=Pi(e),i=this.children.get(r);return i?i.foreachOnPath_(Oi(e),Mi(t,r),n):new ss(null)}}foreach(e){this.foreach_(Ri(),e)}foreach_(e,t){this.children.inorderTraversal(((n,r)=>{r.foreach_(Mi(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class as{constructor(e){this.writeTree_=e}static empty(){return new as(new ss(null))}}function ls(e,t,n){if(Fi(t))return new as(new ss(n));{const r=e.writeTree_.findRootMostValueAndPath(t);if(null!=r){const i=r.path;let o=r.value;const s=zi(i,t);return o=o.updateChild(s,n),new as(e.writeTree_.set(i,o))}{const r=new ss(n),i=e.writeTree_.setTree(t,r);return new as(i)}}}function cs(e,t,n){let r=e;return ii(n,((e,n)=>{r=ls(r,Mi(t,e),n)})),r}function us(e,t){if(Fi(t))return as.empty();{const n=e.writeTree_.setTree(t,new ss(null));return new as(n)}}function hs(e,t){return null!=ds(e,t)}function ds(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(zi(n.path,t)):null}function ps(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(po,((e,n)=>{t.push(new Yi(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new Yi(e,n.value))})),t}function fs(e,t){if(Fi(t))return e;{const n=ds(e,t);return new as(null!=n?new ss(n):e.writeTree_.subtree(t))}}function gs(e){return e.writeTree_.isEmpty()}function ms(e,t){return vs(Ri(),e.writeTree_,t)}function vs(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let r=null;return t.children.inorderTraversal(((t,i)=>{".priority"===t?(ye(null!==i.value,"Priority writes must always be leaf nodes"),r=i.value):n=vs(Mi(e,t),i,n)})),n.getChild(e).isEmpty()||null===r||(n=n.updateChild(Mi(e,".priority"),r)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ys(e,t){return Rs(t,e)}function _s(e,t){const n=e.allWrites.findIndex((e=>e.writeId===t));ye(n>=0,"removeWrite called with nonexistent writeId.");const r=e.allWrites[n];e.allWrites.splice(n,1);let i=r.visible,o=!1,s=e.allWrites.length-1;for(;i&&s>=0;){const t=e.allWrites[s];t.visible&&(s>=n&&ws(t,r.path)?i=!1:Wi(r.path,t.path)&&(o=!0)),s--}if(i){if(o)return function(e){e.visibleWrites=xs(e.allWrites,bs,Ri()),e.allWrites.length>0?e.lastWriteId=e.allWrites[e.allWrites.length-1].writeId:e.lastWriteId=-1}(e),!0;if(r.snap)e.visibleWrites=us(e.visibleWrites,r.path);else{ii(r.children,(t=>{e.visibleWrites=us(e.visibleWrites,Mi(r.path,t))}))}return!0}return!1}function ws(e,t){if(e.snap)return Wi(e.path,t);for(const n in e.children)if(e.children.hasOwnProperty(n)&&Wi(Mi(e.path,n),t))return!0;return!1}function bs(e){return e.visible}function xs(e,t,n){let r=as.empty();for(let i=0;i<e.length;++i){const o=e[i];if(t(o)){const e=o.path;let t;if(o.snap)Wi(n,e)?(t=zi(n,e),r=ls(r,t,o.snap)):Wi(e,n)&&(t=zi(e,n),r=ls(r,Ri(),o.snap.getChild(t)));else{if(!o.children)throw _e("WriteRecord should have .snap or .children");if(Wi(n,e))t=zi(n,e),r=cs(r,t,o.children);else if(Wi(e,n))if(t=zi(e,n),Fi(t))r=cs(r,Ri(),o.children);else{const e=Me(o.children,Pi(t));if(e){const n=e.getChild(Oi(t));r=ls(r,Ri(),n)}}}}}return r}function ks(e,t,n,r,i){if(r||i){const o=fs(e.visibleWrites,t);if(!i&&gs(o))return n;if(i||null!=n||hs(o,Ri())){const o=function(e){return(e.visible||i)&&(!r||!~r.indexOf(e.writeId))&&(Wi(e.path,t)||Wi(t,e.path))};return ms(xs(e.allWrites,o,t),n||bo.EMPTY_NODE)}return null}{const r=ds(e.visibleWrites,t);if(null!=r)return r;{const r=fs(e.visibleWrites,t);if(gs(r))return n;if(null!=n||hs(r,Ri())){return ms(r,n||bo.EMPTY_NODE)}return null}}}function Cs(e,t,n,r){return ks(e.writeTree,e.treePath,t,n,r)}function Is(e,t){return function(e,t,n){let r=bo.EMPTY_NODE;const i=ds(e.visibleWrites,t);if(i)return i.isLeafNode()||i.forEachChild(po,((e,t)=>{r=r.updateImmediateChild(e,t)})),r;if(n){const i=fs(e.visibleWrites,t);return n.forEachChild(po,((e,t)=>{const n=ms(fs(i,new Ni(e)),t);r=r.updateImmediateChild(e,n)})),ps(i).forEach((e=>{r=r.updateImmediateChild(e.name,e.node)})),r}return ps(fs(e.visibleWrites,t)).forEach((e=>{r=r.updateImmediateChild(e.name,e.node)})),r}(e.writeTree,e.treePath,t)}function Ts(e,t,n,r){return function(e,t,n,r,i){ye(r||i,"Either existingEventSnap or existingServerSnap must exist");const o=Mi(t,n);if(hs(e.visibleWrites,o))return null;{const t=fs(e.visibleWrites,o);return gs(t)?i.getChild(n):ms(t,i.getChild(n))}}(e.writeTree,e.treePath,t,n,r)}function Ss(e,t){return function(e,t){return ds(e.visibleWrites,t)}(e.writeTree,Mi(e.treePath,t))}function Es(e,t,n,r,i,o){return function(e,t,n,r,i,o,s){let a;const l=fs(e.visibleWrites,t),c=ds(l,Ri());if(null!=c)a=c;else{if(null==n)return[];a=ms(l,n)}if(a=a.withIndex(s),a.isEmpty()||a.isLeafNode())return[];{const e=[],t=s.getCompare(),n=o?a.getReverseIteratorFrom(r,s):a.getIteratorFrom(r,s);let l=n.getNext();for(;l&&e.length<i;)0!==t(l,r)&&e.push(l),l=n.getNext();return e}}(e.writeTree,e.treePath,t,n,r,i,o)}function $s(e,t,n){return function(e,t,n,r){const i=Mi(t,n),o=ds(e.visibleWrites,i);if(null!=o)return o;if(r.isCompleteForChild(n))return ms(fs(e.visibleWrites,i),r.getNode().getImmediateChild(n));return null}(e.writeTree,e.treePath,t,n)}function Ns(e,t){return Rs(Mi(e.treePath,t),e.writeTree)}function Rs(e,t){return{treePath:e,writeTree:t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qs=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class Os{constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Qo(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return $s(this.writes_,e,t)}}getChildAfterChild(e,t,n){const r=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:is(this.viewCache_),i=Es(this.writes_,r,t,1,n,e);return 0===i.length?null:i[0]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function As(e,t,n,r,i){const o=new Ps;let s,a;if(n.type===Ho.OVERWRITE){const l=n;l.source.fromUser?s=Ms(e,t,l.path,l.snap,r,i,o):(ye(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered()&&!Fi(l.path),s=Ls(e,t,l.path,l.snap,r,i,a,o))}else if(n.type===Ho.MERGE){const l=n;l.source.fromUser?s=function(e,t,n,r,i,o,s){let a=t;return r.foreach(((r,l)=>{const c=Mi(n,r);Fs(t,Pi(c))&&(a=Ms(e,a,c,l,i,o,s))})),r.foreach(((r,l)=>{const c=Mi(n,r);Fs(t,Pi(c))||(a=Ms(e,a,c,l,i,o,s))})),a}(e,t,l.path,l.children,r,i,o):(ye(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered(),s=Us(e,t,l.path,l.children,r,i,a,o))}else if(n.type===Ho.ACK_USER_WRITE){const a=n;s=a.revert?function(e,t,n,r,i,o){let s;if(null!=Ss(r,n))return t;{const a=new Os(r,t,i),l=t.eventCache.getNode();let c;if(Fi(n)||".priority"===Pi(n)){let n;if(t.serverCache.isFullyInitialized())n=Cs(r,is(t));else{const e=t.serverCache.getNode();ye(e instanceof bo,"serverChildren would be complete if leaf node"),n=Is(r,e)}n=n,c=e.filter.updateFullNode(l,n,o)}else{const i=Pi(n);let u=$s(r,i,t.serverCache);null==u&&t.serverCache.isCompleteForChild(i)&&(u=l.getImmediateChild(i)),c=null!=u?e.filter.updateChild(l,i,u,Oi(n),a,o):t.eventCache.getNode().hasChild(i)?e.filter.updateChild(l,i,bo.EMPTY_NODE,Oi(n),a,o):l,c.isEmpty()&&t.serverCache.isFullyInitialized()&&(s=Cs(r,is(t)),s.isLeafNode()&&(c=e.filter.updateFullNode(c,s,o)))}return s=t.serverCache.isFullyInitialized()||null!=Ss(r,Ri()),ts(t,c,s,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,a.path,r,i,o):function(e,t,n,r,i,o,s){if(null!=Ss(i,n))return t;const a=t.serverCache.isFiltered(),l=t.serverCache;if(null!=r.value){if(Fi(n)&&l.isFullyInitialized()||l.isCompleteForPath(n))return Ls(e,t,n,l.getNode().getChild(n),i,o,a,s);if(Fi(n)){let r=new ss(null);return l.getNode().forEachChild(Xi,((e,t)=>{r=r.set(new Ni(e),t)})),Us(e,t,n,r,i,o,a,s)}return t}{let c=new ss(null);return r.foreach(((e,t)=>{const r=Mi(n,e);l.isCompleteForPath(r)&&(c=c.set(e,l.getNode().getChild(r)))})),Us(e,t,n,c,i,o,a,s)}}(e,t,a.path,a.affectedTree,r,i,o)}else{if(n.type!==Ho.LISTEN_COMPLETE)throw _e("Unknown operation type: "+n.type);s=function(e,t,n,r,i){const o=t.serverCache,s=ns(t,o.getNode(),o.isFullyInitialized()||Fi(n),o.isFiltered());return Ds(e,s,n,r,qs,i)}(e,t,n.path,r,o)}const l=o.getChanges();return function(e,t,n){const r=t.eventCache;if(r.isFullyInitialized()){const i=r.getNode().isLeafNode()||r.getNode().isEmpty(),o=rs(e);(n.length>0||!e.eventCache.isFullyInitialized()||i&&!r.getNode().equals(o)||!r.getNode().getPriority().equals(o.getPriority()))&&n.push(Eo(rs(t)))}}(t,s,l),{viewCache:s,changes:l}}function Ds(e,t,n,r,i,o){const s=t.eventCache;if(null!=Ss(r,n))return t;{let a,l;if(Fi(n))if(ye(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){const n=is(t),i=Is(r,n instanceof bo?n:bo.EMPTY_NODE);a=e.filter.updateFullNode(t.eventCache.getNode(),i,o)}else{const n=Cs(r,is(t));a=e.filter.updateFullNode(t.eventCache.getNode(),n,o)}else{const c=Pi(n);if(".priority"===c){ye(1===qi(n),"Can't have a priority with additional path components");const i=s.getNode();l=t.serverCache.getNode();const o=Ts(r,n,i,l);a=null!=o?e.filter.updatePriority(i,o):s.getNode()}else{const u=Oi(n);let h;if(s.isCompleteForChild(c)){l=t.serverCache.getNode();const e=Ts(r,n,s.getNode(),l);h=null!=e?s.getNode().getImmediateChild(c).updateChild(u,e):s.getNode().getImmediateChild(c)}else h=$s(r,c,t.serverCache);a=null!=h?e.filter.updateChild(s.getNode(),c,h,u,i,o):s.getNode()}}return ts(t,a,s.isFullyInitialized()||Fi(n),e.filter.filtersNodes())}}function Ls(e,t,n,r,i,o,s,a){const l=t.serverCache;let c;const u=s?e.filter:e.filter.getIndexedFilter();if(Fi(n))c=u.updateFullNode(l.getNode(),r,null);else if(u.filtersNodes()&&!l.isFiltered()){const e=l.getNode().updateChild(n,r);c=u.updateFullNode(l.getNode(),e,null)}else{const e=Pi(n);if(!l.isCompleteForPath(n)&&qi(n)>1)return t;const i=Oi(n),o=l.getNode().getImmediateChild(e).updateChild(i,r);c=".priority"===e?u.updatePriority(l.getNode(),o):u.updateChild(l.getNode(),e,o,i,qs,null)}const h=ns(t,c,l.isFullyInitialized()||Fi(n),u.filtersNodes());return Ds(e,h,n,i,new Os(i,h,o),a)}function Ms(e,t,n,r,i,o,s){const a=t.eventCache;let l,c;const u=new Os(i,t,o);if(Fi(n))c=e.filter.updateFullNode(t.eventCache.getNode(),r,s),l=ts(t,c,!0,e.filter.filtersNodes());else{const i=Pi(n);if(".priority"===i)c=e.filter.updatePriority(t.eventCache.getNode(),r),l=ts(t,c,a.isFullyInitialized(),a.isFiltered());else{const o=Oi(n),c=a.getNode().getImmediateChild(i);let h;if(Fi(o))h=r;else{const e=u.getCompleteChild(i);h=null!=e?".priority"===Ai(o)&&e.getChild(Li(o)).isEmpty()?e:e.updateChild(o,r):bo.EMPTY_NODE}if(c.equals(h))l=t;else{l=ts(t,e.filter.updateChild(a.getNode(),i,h,o,u,s),a.isFullyInitialized(),e.filter.filtersNodes())}}}return l}function Fs(e,t){return e.eventCache.isCompleteForChild(t)}function zs(e,t,n){return n.foreach(((e,n)=>{t=t.updateChild(e,n)})),t}function Us(e,t,n,r,i,o,s,a){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;let l,c=t;l=Fi(n)?r:new ss(null).setTree(n,r);const u=t.serverCache.getNode();return l.children.inorderTraversal(((n,r)=>{if(u.hasChild(n)){const l=zs(0,t.serverCache.getNode().getImmediateChild(n),r);c=Ls(e,c,new Ni(n),l,i,o,s,a)}})),l.children.inorderTraversal(((n,r)=>{const l=!t.serverCache.isCompleteForChild(n)&&void 0===r.value;if(!u.hasChild(n)&&!l){const l=zs(0,t.serverCache.getNode().getImmediateChild(n),r);c=Ls(e,c,new Ni(n),l,i,o,s,a)}})),c}class js{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const n=this.query_._queryParams,r=new Po(n.getIndex()),i=(o=n).loadsAllData()?new Po(o.getIndex()):o.hasLimit()?new Oo(o):new qo(o);var o;this.processor_=function(e){return{filter:e}}(i);const s=t.serverCache,a=t.eventCache,l=r.updateFullNode(bo.EMPTY_NODE,s.getNode(),null),c=i.updateFullNode(bo.EMPTY_NODE,a.getNode(),null),u=new Qo(l,s.isFullyInitialized(),r.filtersNodes()),h=new Qo(c,a.isFullyInitialized(),i.filtersNodes());this.viewCache_=es(h,u),this.eventGenerator_=new Zo(this.query_)}get query(){return this.query_}}function Ws(e,t){const n=is(e.viewCache_);return n&&(e.query._queryParams.loadsAllData()||!Fi(t)&&!n.getImmediateChild(Pi(t)).isEmpty())?n.getChild(t):null}function Vs(e){return 0===e.eventRegistrations_.length}function Hs(e,t,n){const r=[];if(n){ye(null==t,"A cancel should cancel all event registrations.");const i=e.query._path;e.eventRegistrations_.forEach((e=>{const t=e.createCancelEvent(n,i);t&&r.push(t)}))}if(t){let n=[];for(let r=0;r<e.eventRegistrations_.length;++r){const i=e.eventRegistrations_[r];if(i.matches(t)){if(t.hasAnyCallback()){n=n.concat(e.eventRegistrations_.slice(r+1));break}}else n.push(i)}e.eventRegistrations_=n}else e.eventRegistrations_=[];return r}function Bs(e,t,n,r){t.type===Ho.MERGE&&null!==t.source.queryId&&(ye(is(e.viewCache_),"We should always have a full cache before handling merges"),ye(rs(e.viewCache_),"Missing event cache, even though we have a server cache"));const i=e.viewCache_,o=As(e.processor_,i,t,n,r);var s,a;return s=e.processor_,a=o.viewCache,ye(a.eventCache.getNode().isIndexed(s.filter.getIndex()),"Event snap not indexed"),ye(a.serverCache.getNode().isIndexed(s.filter.getIndex()),"Server snap not indexed"),ye(o.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),e.viewCache_=o.viewCache,Gs(e,o.changes,o.viewCache.eventCache.getNode(),null)}function Gs(e,t,n,r){const i=r?[r]:e.eventRegistrations_;return function(e,t,n,r){const i=[],o=[];return t.forEach((t=>{var n;"child_changed"===t.type&&e.index_.indexedValueChanged(t.oldSnap,t.snapshotNode)&&o.push((n=t.childName,{type:"child_moved",snapshotNode:t.snapshotNode,childName:n}))})),Xo(e,i,"child_removed",t,r,n),Xo(e,i,"child_added",t,r,n),Xo(e,i,"child_moved",o,r,n),Xo(e,i,"child_changed",t,r,n),Xo(e,i,"value",t,r,n),i}(e.eventGenerator_,t,n,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ks,Ys;class Js{constructor(){this.views=new Map}}function Qs(e,t,n,r){const i=t.source.queryId;if(null!==i){const o=e.views.get(i);return ye(null!=o,"SyncTree gave us an op for an invalid query."),Bs(o,t,n,r)}{let i=[];for(const o of e.views.values())i=i.concat(Bs(o,t,n,r));return i}}function Zs(e,t,n,r,i,o){const s=function(e,t,n,r,i){const o=t._queryIdentifier,s=e.views.get(o);if(!s){let e=Cs(n,i?r:null),o=!1;e?o=!0:r instanceof bo?(e=Is(n,r),o=!1):(e=bo.EMPTY_NODE,o=!1);const s=es(new Qo(e,o,!1),new Qo(r,i,!1));return new js(t,s)}return s}(e,t,r,i,o);return e.views.has(t._queryIdentifier)||e.views.set(t._queryIdentifier,s),function(e,t){e.eventRegistrations_.push(t)}(s,n),function(e,t){const n=e.viewCache_.eventCache,r=[];n.getNode().isLeafNode()||n.getNode().forEachChild(po,((e,t)=>{r.push($o(e,t))}));return n.isFullyInitialized()&&r.push(Eo(n.getNode())),Gs(e,r,n.getNode(),t)}(s,n)}function Xs(e,t,n,r){const i=t._queryIdentifier,o=[];let s=[];const a=ia(e);if("default"===i)for(const[t,i]of e.views.entries())s=s.concat(Hs(i,n,r)),Vs(i)&&(e.views.delete(t),i.query._queryParams.loadsAllData()||o.push(i.query));else{const t=e.views.get(i);t&&(s=s.concat(Hs(t,n,r)),Vs(t)&&(e.views.delete(i),t.query._queryParams.loadsAllData()||o.push(t.query)))}return a&&!ia(e)&&o.push(new(ye(Ks,"Reference.ts has not been loaded"),Ks)(t._repo,t._path)),{removed:o,events:s}}function ea(e){const t=[];for(const n of e.views.values())n.query._queryParams.loadsAllData()||t.push(n);return t}function ta(e,t){let n=null;for(const r of e.views.values())n=n||Ws(r,t);return n}function na(e,t){if(t._queryParams.loadsAllData())return oa(e);{const n=t._queryIdentifier;return e.views.get(n)}}function ra(e,t){return null!=na(e,t)}function ia(e){return null!=oa(e)}function oa(e){for(const t of e.views.values())if(t.query._queryParams.loadsAllData())return t;return null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let sa=1;class aa{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ss(null),this.pendingWriteTree_={visibleWrites:as.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function la(e,t,n,r,i){return function(e,t,n,r,i){ye(r>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===i&&(i=!0),e.allWrites.push({path:t,snap:n,writeId:r,visible:i}),i&&(e.visibleWrites=ls(e.visibleWrites,t,n)),e.lastWriteId=r}(e.pendingWriteTree_,t,n,r,i),i?ga(e,new Yo({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function ca(e,t,n,r){!function(e,t,n,r){ye(r>e.lastWriteId,"Stacking an older merge on top of newer ones"),e.allWrites.push({path:t,children:n,writeId:r,visible:!0}),e.visibleWrites=cs(e.visibleWrites,t,n),e.lastWriteId=r}(e.pendingWriteTree_,t,n,r);const i=ss.fromObject(n);return ga(e,new Jo({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,i))}function ua(e,t,n=!1){const r=function(e,t){for(let n=0;n<e.allWrites.length;n++){const r=e.allWrites[n];if(r.writeId===t)return r}return null}(e.pendingWriteTree_,t);if(_s(e.pendingWriteTree_,t)){let t=new ss(null);return null!=r.snap?t=t.set(Ri(),!0):ii(r.children,(e=>{t=t.set(new Ni(e),!0)})),ga(e,new Go(r.path,t,n))}return[]}function ha(e,t,n){return ga(e,new Yo({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function da(e,t,n,r){const i=t._path,o=e.syncPointTree_.get(i);let s=[];if(o&&("default"===t._queryIdentifier||ra(o,t))){const a=Xs(o,t,n,r);0===o.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(i));const l=a.removed;s=a.events;const c=-1!==l.findIndex((e=>e._queryParams.loadsAllData())),u=e.syncPointTree_.findOnPath(i,((e,t)=>ia(t)));if(c&&!u){const t=e.syncPointTree_.subtree(i);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&ia(t)){return[oa(t)]}{let e=[];return t&&(e=ea(t)),ii(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const r=n[t],i=r.query,o=ya(e,r);e.listenProvider_.startListening(Ca(i),_a(e,i),o.hashFn,o.onComplete)}}}if(!u&&l.length>0&&!r)if(c){const n=null;e.listenProvider_.stopListening(Ca(t),n)}else l.forEach((t=>{const n=e.queryToTagMap.get(wa(t));e.listenProvider_.stopListening(Ca(t),n)}));!function(e,t){for(let n=0;n<t.length;++n){const r=t[n];if(!r._queryParams.loadsAllData()){const t=wa(r),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,l)}return s}function pa(e,t,n){const r=t._path;let i=null,o=!1;e.syncPointTree_.foreachOnPath(r,((e,t)=>{const n=zi(e,r);i=i||ta(t,n),o=o||ia(t)}));let s,a=e.syncPointTree_.get(r);if(a?(o=o||ia(a),i=i||ta(a,Ri())):(a=new Js,e.syncPointTree_=e.syncPointTree_.set(r,a)),null!=i)s=!0;else{s=!1,i=bo.EMPTY_NODE;e.syncPointTree_.subtree(r).foreachChild(((e,t)=>{const n=ta(t,Ri());n&&(i=i.updateImmediateChild(e,n))}))}const l=ra(a,t);if(!l&&!t._queryParams.loadsAllData()){const n=wa(t);ye(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const r=sa++;e.queryToTagMap.set(n,r),e.tagToQueryMap.set(r,n)}let c=Zs(a,t,n,ys(e.pendingWriteTree_,r),i,s);if(!l&&!o){const n=na(a,t);c=c.concat(function(e,t,n){const r=t._path,i=_a(e,t),o=ya(e,n),s=e.listenProvider_.startListening(Ca(t),i,o.hashFn,o.onComplete),a=e.syncPointTree_.subtree(r);if(i)ye(!ia(a.value),"If we're adding a query, it shouldn't be shadowed");else{const t=a.fold(((e,t,n)=>{if(!Fi(e)&&t&&ia(t))return[oa(t).query];{let e=[];return t&&(e=e.concat(ea(t).map((e=>e.query)))),ii(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const r=t[n];e.listenProvider_.stopListening(Ca(r),_a(e,r))}}return s}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))}return c}function fa(e,t,n){const r=e.pendingWriteTree_,i=e.syncPointTree_.findOnPath(t,((e,n)=>{const r=ta(n,zi(e,t));if(r)return r}));return ks(r,t,i,n,!0)}function ga(e,t){return ma(t,e.syncPointTree_,null,ys(e.pendingWriteTree_,Ri()))}function ma(e,t,n,r){if(Fi(e.path))return va(e,t,n,r);{const i=t.get(Ri());null==n&&null!=i&&(n=ta(i,Ri()));let o=[];const s=Pi(e.path),a=e.operationForChild(s),l=t.children.get(s);if(l&&a){const e=n?n.getImmediateChild(s):null,t=Ns(r,s);o=o.concat(ma(a,l,e,t))}return i&&(o=o.concat(Qs(i,e,r,n))),o}}function va(e,t,n,r){const i=t.get(Ri());null==n&&null!=i&&(n=ta(i,Ri()));let o=[];return t.children.inorderTraversal(((t,i)=>{const s=n?n.getImmediateChild(t):null,a=Ns(r,t),l=e.operationForChild(t);l&&(o=o.concat(va(l,i,s,a)))})),i&&(o=o.concat(Qs(i,e,r,n))),o}function ya(e,t){const n=t.query,r=_a(e,n);return{hashFn:()=>(function(e){return e.viewCache_.serverCache.getNode()}(t)||bo.EMPTY_NODE).hash(),onComplete:t=>{if("ok"===t)return r?function(e,t,n){const r=ba(e,n);if(r){const n=xa(r),i=n.path,o=n.queryId,s=zi(i,t);return ka(e,i,new Ko(Bo(o),s))}return[]}(e,n._path,r):function(e,t){return ga(e,new Ko({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t))}(e,n._path);{const r=function(e,t){let n="Unknown Error";"too_big"===e?n="The data requested exceeds the maximum size that can be accessed with a single request.":"permission_denied"===e?n="Client doesn't have permission to access the desired data.":"unavailable"===e&&(n="The service is unavailable");const r=new Error(e+" at "+t._path.toString()+": "+n);return r.code=e.toUpperCase(),r}(t,n);return da(e,n,null,r)}}}}function _a(e,t){const n=wa(t);return e.queryToTagMap.get(n)}function wa(e){return e._path.toString()+"$"+e._queryIdentifier}function ba(e,t){return e.tagToQueryMap.get(t)}function xa(e){const t=e.indexOf("$");return ye(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Ni(e.substr(0,t))}}function ka(e,t,n){const r=e.syncPointTree_.get(t);ye(r,"Missing sync point for query tag that we're tracking");return Qs(r,n,ys(e.pendingWriteTree_,t),null)}function Ca(e){return e._queryParams.loadsAllData()&&!e._queryParams.isDefault()?new(ye(Ys,"Reference.ts has not been loaded"),Ys)(e._repo,e._path):e}class Ia{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new Ia(t)}node(){return this.node_}}class Ta{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=Mi(this.path_,e);return new Ta(this.syncTree_,t)}node(){return fa(this.syncTree_,this.path_)}}const Sa=function(e,t,n){return e&&"object"==typeof e?(ye(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"]?Ea(e[".sv"],t,n):"object"==typeof e[".sv"]?$a(e[".sv"],t):void ye(!1,"Unexpected server value: "+JSON.stringify(e,null,2))):e},Ea=function(e,t,n){switch(e){case"timestamp":return n.timestamp;default:ye(!1,"Unexpected server value: "+e)}},$a=function(e,t,n){e.hasOwnProperty("increment")||ye(!1,"Unexpected server value: "+JSON.stringify(e,null,2));const r=e.increment;"number"!=typeof r&&ye(!1,"Unexpected increment value: "+r);const i=t.node();if(ye(null!=i,"Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return r;const o=i.getValue();return"number"!=typeof o?r:o+r},Na=function(e,t,n,r){return Pa(t,new Ta(n,e),r)},Ra=function(e,t,n){return Pa(e,new Ia(t),n)};function Pa(e,t,n){const r=e.getPriority().val(),i=Sa(r,t.getImmediateChild(".priority"),n);let o;if(e.isLeafNode()){const r=e,o=Sa(r.getValue(),t,n);return o!==r.getValue()||i!==r.getPriority().val()?new ho(o,ko(i)):e}{const r=e;return o=r,i!==r.getPriority().val()&&(o=o.updatePriority(new ho(i))),r.forEachChild(po,((e,r)=>{const i=Pa(r,t.getImmediateChild(e),n);i!==r&&(o=o.updateImmediateChild(e,i))})),o}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Xa{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function el(e,t){let n=null;for(let r=0;r<t.length;r++){const i=t[r],o=i.getPath();null===n||ji(o,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:o}),n.events.push(i)}n&&e.eventLists_.push(n)}function tl(e,t,n){el(e,n),rl(e,(e=>ji(e,t)))}function nl(e,t,n){el(e,n),rl(e,(e=>Wi(e,t)||Wi(t,e)))}function rl(e,t){e.recursionDepth_++;let n=!0;for(let r=0;r<e.eventLists_.length;r++){const i=e.eventLists_[r];if(i){t(i.path)?(il(e.eventLists_[r]),e.eventLists_[r]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function il(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const r=n.getEventRunner();Wr&&Hr("event: "+n.toString()),li(r)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ol{constructor(e,t,n,r){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=r,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Xa,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=zo(),this.transactionQueueTree_=new qa,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function sl(e,t,n){if(e.stats_=_i(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new Mo(e.repoInfo_,((t,n,r,i)=>{cl(e,t,n,r,i)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>ul(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Ae(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new Ki(e.repoInfo_,t,((t,n,r,i)=>{cl(e,t,n,r,i)}),(t=>{ul(e,t)}),(t=>{!function(e,t){ii(t,((t,n)=>{hl(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return yi[n]||(yi[n]=t()),yi[n]}(e.repoInfo_,(()=>new Vo(e.stats_,e.server_))),e.infoData_=new Fo,e.infoSyncTree_=new aa({startListening:(t,n,r,i)=>{let o=[];const s=e.infoData_.getNode(t._path);return s.isEmpty()||(o=ha(e.infoSyncTree_,t._path,s),setTimeout((()=>{i("ok")}),0)),o},stopListening:()=>{}}),hl(e,"connected",!1),e.serverSyncTree_=new aa({startListening:(t,n,r,i)=>(e.server_.listen(t,r,n,((n,r)=>{const o=i(n,r);nl(e.eventQueue_,t._path,o)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function al(e){const t=e.infoData_.getNode(new Ni(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function ll(e){return(t=(t={timestamp:al(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function cl(e,t,n,r,i){e.dataUpdateCount++;const o=new Ni(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let s=[];if(i)if(r){const t=ze(n,(e=>ko(e)));s=function(e,t,n,r){const i=ba(e,r);if(i){const r=xa(i),o=r.path,s=r.queryId,a=zi(o,t),l=ss.fromObject(n);return ka(e,o,new Jo(Bo(s),a,l))}return[]}(e.serverSyncTree_,o,t,i)}else{const t=ko(n);s=function(e,t,n,r){const i=ba(e,r);if(null!=i){const r=xa(i),o=r.path,s=r.queryId,a=zi(o,t);return ka(e,o,new Yo(Bo(s),a,n))}return[]}(e.serverSyncTree_,o,t,i)}else if(r){const t=ze(n,(e=>ko(e)));s=function(e,t,n){const r=ss.fromObject(n);return ga(e,new Jo({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,r))}(e.serverSyncTree_,o,t)}else{const t=ko(n);s=ha(e.serverSyncTree_,o,t)}let a=o;s.length>0&&(a=yl(e,o)),nl(e.eventQueue_,a,s)}function ul(e,t){hl(e,"connected",t),!1===t&&function(e){fl(e,"onDisconnectEvents");const t=ll(e),n=zo();jo(e.onDisconnect_,Ri(),((r,i)=>{const o=Na(r,i,e.serverSyncTree_,t);Uo(n,r,o)}));let r=[];jo(n,Ri(),((t,n)=>{r=r.concat(ha(e.serverSyncTree_,t,n));const i=kl(e,t);yl(e,i)})),e.onDisconnect_=zo(),nl(e.eventQueue_,Ri(),r)}(e)}function hl(e,t,n){const r=new Ni("/.info/"+t),i=ko(n);e.infoData_.updateSnapshot(r,i);const o=ha(e.infoSyncTree_,r,i);nl(e.eventQueue_,r,o)}function dl(e){return e.nextWriteId_++}function pl(e,t,n){let r;r=".info"===Pi(t._path)?da(e.infoSyncTree_,t,n):da(e.serverSyncTree_,t,n),tl(e.eventQueue_,t._path,r)}function fl(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),Hr(n,...t)}function gl(e,t,n,r){t&&li((()=>{if("ok"===n)t(null);else{const e=(n||"error").toUpperCase();let i=e;r&&(i+=": "+r);const o=new Error(i);o.code=e,t(o)}}))}function ml(e,t,n){return fa(e.serverSyncTree_,t,n)||bo.EMPTY_NODE}function vl(e,t=e.transactionQueueTree_){if(t||xl(e,t),Aa(t)){const n=wl(e,t);ye(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const r=n.map((e=>e.currentWriteId)),i=ml(e,t,r);let o=i;const s=i.hash();for(let e=0;e<n.length;e++){const r=n[e];ye(0===r.status,"tryToSendTransactionQueue_: items in queue should all be run."),r.status=1,r.retryCount++;const i=zi(t,r.path);o=o.updateChild(i,r.currentOutputSnapshotRaw)}const a=o.val(!0),l=t;e.server_.put(l.toString(),a,(r=>{fl(e,"transaction put response",{path:l.toString(),status:r});let i=[];if("ok"===r){const r=[];for(let t=0;t<n.length;t++)n[t].status=2,i=i.concat(ua(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&r.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();xl(e,Oa(e.transactionQueueTree_,t)),vl(e,e.transactionQueueTree_),nl(e.eventQueue_,t,i);for(let e=0;e<r.length;e++)li(r[e])}else{if("datastale"===r)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{Yr("transaction at "+l.toString()+" failed: "+r);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=r}yl(e,t)}}),s)}(e,za(t),n)}else La(t)&&Ma(t,(t=>{vl(e,t)}))}function yl(e,t){const n=_l(e,t),r=za(n);return function(e,t,n){if(0===t.length)return;const r=[];let i=[];const o=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let a=0;a<t.length;a++){const l=t[a],c=zi(n,l.path);let u,h=!1;if(ye(null!==c,"rerunTransactionsUnderNode_: relativePath should not be null."),4===l.status)h=!0,u=l.abortReason,i=i.concat(ua(e.serverSyncTree_,l.currentWriteId,!0));else if(0===l.status)if(l.retryCount>=25)h=!0,u="maxretry",i=i.concat(ua(e.serverSyncTree_,l.currentWriteId,!0));else{const n=ml(e,l.path,o);l.currentInputSnapshot=n;const r=t[a].update(n.val());if(void 0!==r){Ka("transaction failed: Data returned ",r,l.path);let t=ko(r);"object"==typeof r&&null!=r&&Le(r,".priority")||(t=t.updatePriority(n.getPriority()));const s=l.currentWriteId,a=ll(e),c=Ra(t,n,a);l.currentOutputSnapshotRaw=t,l.currentOutputSnapshotResolved=c,l.currentWriteId=dl(e),o.splice(o.indexOf(s),1),i=i.concat(la(e.serverSyncTree_,l.path,c,l.currentWriteId,l.applyLocally)),i=i.concat(ua(e.serverSyncTree_,s,!0))}else h=!0,u="nodata",i=i.concat(ua(e.serverSyncTree_,l.currentWriteId,!0))}nl(e.eventQueue_,n,i),i=[],h&&(t[a].status=2,s=t[a].unwatcher,setTimeout(s,Math.floor(0)),t[a].onComplete&&("nodata"===u?r.push((()=>t[a].onComplete(null,!1,t[a].currentInputSnapshot))):r.push((()=>t[a].onComplete(new Error(u),!1,null)))))}var s;xl(e,e.transactionQueueTree_);for(let e=0;e<r.length;e++)li(r[e]);vl(e,e.transactionQueueTree_)}(e,wl(e,n),r),r}function _l(e,t){let n,r=e.transactionQueueTree_;for(n=Pi(t);null!==n&&void 0===Aa(r);)r=Oa(r,n),n=Pi(t=Oi(t));return r}function wl(e,t){const n=[];return bl(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function bl(e,t,n){const r=Aa(t);if(r)for(let e=0;e<r.length;e++)n.push(r[e]);Ma(t,(t=>{bl(e,t,n)}))}function xl(e,t){const n=Aa(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,Da(t,n.length>0?n:void 0)}Ma(t,(t=>{xl(e,t)}))}function kl(e,t){const n=za(_l(e,t)),r=Oa(e.transactionQueueTree_,t);return function(e,t,n){let r=n?e:e.parent;for(;null!==r;){if(t(r))return!0;r=r.parent}}(r,(t=>{Cl(e,t)})),Cl(e,r),Fa(r,(t=>{Cl(e,t)})),n}function Cl(e,t){const n=Aa(t);if(n){const r=[];let i=[],o=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(ye(o===t-1,"All SENT items should be at beginning of queue."),o=t,n[t].status=3,n[t].abortReason="set"):(ye(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),i=i.concat(ua(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&r.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===o?Da(t,void 0):n.length=o+1,nl(e.eventQueue_,za(t),i);for(let e=0;e<r.length;e++)li(r[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nl{constructor(e,t,n,r){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=r}get key(){return Fi(this._path)?null:Ai(this._path)}get ref(){return new Rl(this._repo,this._path)}get _queryIdentifier(){const e=Lo(this._queryParams),t=ni(e);return"{}"===t?"default":t}get _queryObject(){return Lo(this._queryParams)}isEqual(e){if(!((e=Ge(e))instanceof Nl))return!1;const t=this._repo===e._repo,n=ji(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return t&&n&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}}class Rl extends Nl{constructor(e,t){super(e,t,new Ao,!1)}get parent(){const e=Li(this._path);return null===e?null:new Rl(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}}class Pl{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new Ni(e),n=Ol(this.ref,e);return new Pl(this._node.getChild(t),n,po)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new Pl(n,Ol(this.ref,t),po))))}hasChild(e){const t=new Ni(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function ql(e,t){return(e=Ge(e))._checkNotDeleted("ref"),void 0!==t?Ol(e._root,t):e._root}function Ol(e,t){var n,r,i,o;return null===Pi((e=Ge(e))._path)?(n="child",r="path",o=!1,(i=t)&&(i=i.replace(/^\/*\.info(\/|$)/,"/")),Ja(n,r,i,o)):Ja("child","path",t,!1),new Rl(e._repo,Mi(e._path,t))}function Al(e,t){e=Ge(e),Qa("set",e._path),Ga("set",t,e._path,!1);const n=new Ie;return function(e,t,n,r,i){fl(e,"set",{path:t.toString(),value:n,priority:r});const o=ll(e),s=ko(n,r),a=fa(e.serverSyncTree_,t),l=Ra(s,a,o),c=dl(e),u=la(e.serverSyncTree_,t,l,c,!0);el(e.eventQueue_,u),e.server_.put(t.toString(),s.val(!0),((n,r)=>{const o="ok"===n;o||Yr("set at "+t+" failed: "+n);const s=ua(e.serverSyncTree_,c,!o);nl(e.eventQueue_,t,s),gl(0,i,n,r)}));const h=kl(e,t);yl(e,h),nl(e.eventQueue_,h,[])}(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}function Dl(e,t){Ya("update",t,e._path,!1);const n=new Ie;return function(e,t,n,r){fl(e,"update",{path:t.toString(),value:n});let i=!0;const o=ll(e),s={};if(ii(n,((n,r)=>{i=!1,s[n]=Na(Mi(t,n),ko(r),e.serverSyncTree_,o)})),i)Hr("update() called with empty data.  Don't do anything."),gl(0,r,"ok",void 0);else{const i=dl(e),o=ca(e.serverSyncTree_,t,s,i);el(e.eventQueue_,o),e.server_.merge(t.toString(),n,((n,o)=>{const s="ok"===n;s||Yr("update at "+t+" failed: "+n);const a=ua(e.serverSyncTree_,i,!s),l=a.length>0?yl(e,t):t;nl(e.eventQueue_,l,a),gl(0,r,n,o)})),ii(n,(n=>{const r=kl(e,Mi(t,n));yl(e,r)})),nl(e.eventQueue_,t,[])}}(e._repo,e._path,t,n.wrapCallback((()=>{}))),n.promise}class Ll{constructor(e){this.callbackContext=e}respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new Sl("value",this,new Pl(e.snapshotNode,new Rl(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new El(this,e,t):null}matches(e){return e instanceof Ll&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}}class Ml{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t="children_added"===e?"child_added":e;return t="children_removed"===t?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new El(this,e,t):null}createEvent(e,t){ye(null!=e.childName,"Child events should have a childName.");const n=Ol(new Rl(t._repo,t._path),e.childName),r=t._queryParams.getIndex();return new Sl(e.type,this,new Pl(e.snapshotNode,n,r),e.prevName)}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Ml&&(this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)))}hasAnyCallback(){return!!this.callbackContext}}function Fl(e,t,n,r,i){let o;if("object"==typeof r&&(o=void 0,i=r),"function"==typeof r&&(o=r),i&&i.onlyOnce){const t=n,r=(n,r)=>{pl(e._repo,e,a),t(n,r)};r.userCallback=n.userCallback,r.context=n.context,n=r}const s=new $l(n,o||void 0),a="value"===t?new Ll(s):new Ml(t,s);return function(e,t,n){let r;r=".info"===Pi(t._path)?pa(e.infoSyncTree_,t,n):pa(e.serverSyncTree_,t,n),tl(e.eventQueue_,t._path,r)}(e._repo,e,a),()=>pl(e._repo,e,a)}function zl(e,t,n,r){return Fl(e,"value",t,n,r)}class Ul extends class{}{constructor(e){super(),this._path=e}_apply(e){!function(e,t){if(!0===e._orderByCalled)throw new Error(t+": You can't combine multiple orderBy calls.")}(e,"orderByChild");const t=new Ni(this._path);if(Fi(t))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const n=new Co(t),r=function(e,t){const n=e.copy();return n.index_=t,n}(e._queryParams,n);return function(e){let t=null,n=null;if(e.hasStart()&&(t=e.getIndexStartValue()),e.hasEnd()&&(n=e.getIndexEndValue()),e.getIndex()===Xi){const r="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",i="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(e.hasStart()){if(e.getIndexStartName()!==Qr)throw new Error(r);if("string"!=typeof t)throw new Error(i)}if(e.hasEnd()){if(e.getIndexEndName()!==Zr)throw new Error(r);if("string"!=typeof n)throw new Error(i)}}else if(e.getIndex()===po){if(null!=t&&!Ba(t)||null!=n&&!Ba(n))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if(ye(e.getIndex()instanceof Co||e.getIndex()===Io,"unknown index type."),null!=t&&"object"==typeof t||null!=n&&"object"==typeof n)throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}(r),new Nl(e._repo,e._path,r,!0)}}!function(e){ye(!Ks,"__referenceConstructor has already been defined"),Ks=e}(Rl),function(e){ye(!Ys,"__referenceConstructor has already been defined"),Ys=e}(Rl);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const jl={};function Wl(e,t,n,r,i){let o=r||e.options.databaseURL;void 0===o&&(e.options.projectId||Kr("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Hr("Using default host for project ",e.options.projectId),o=`${e.options.projectId}-default-rtdb.firebaseio.com`);let s,a,l=Il(o,i),c=l.repoInfo;"undefined"!=typeof process&&(a=process.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(s=!0,o=`http://${a}?ns=${c.namespace}`,l=Il(o,i),c=l.repoInfo):s=!l.repoInfo.secure;const u=i&&s?new di(di.OWNER):new hi(e.name,e.options,t);Za("Invalid Firebase Database URL",l),Fi(l.path)||Kr("Database URL must point to the root of a Firebase Database (not including a child path).");const h=function(e,t,n,r){let i=jl[t.name];i||(i={},jl[t.name]=i);let o=i[e.toURLString()];o&&Kr("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return o=new ol(e,false,n,r),i[e.toURLString()]=o,o}(c,e,u,new ui(e.name,n));return new Vl(h,e)}class Vl{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(sl(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Rl(this._repo,Ri())),this._rootInternal}_delete(){return this._checkNotDeleted("delete"),function(e,t){const n=jl[t];n&&n[e.key]===e||Kr(`Database ${t}(${e.repoInfo_}) has already been deleted.`),function(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null,Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&Kr("Cannot call "+e+" on a deleted database.")}}function Hl(e=gt(),t){return dt(e,"database-exp").getImmediate({identifier:t})}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
const Bl={".sv":"timestamp"};function Gl(e){return{".sv":{increment:e}}}!function(e){!function(e){qr=e}("9.0.0-beta.7"),ht(new Ke("database-exp",((e,{instanceIdentifier:t})=>Wl(e.getProvider("app-exp").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),mt("@firebase/database","0.0.900-exp.6ef484a04",e)}();const Kl=[];function Yl(t,n=e){let r;const i=new Set;function o(e){if(s(t,e)&&(t=e,r)){const e=!Kl.length;for(const e of i)e[1](),Kl.push(e,t);if(e){for(let e=0;e<Kl.length;e+=2)Kl[e][0](Kl[e+1]);Kl.length=0}}}return{set:o,update:function(e){o(e(t))},subscribe:function(s,a=e){const l=[s,a];return i.add(l),1===i.size&&(r=n(o)||e),s(t),()=>{i.delete(l),0===i.size&&(r(),r=null)}}}}const Jl=()=>{const e=Rr();return{authStore:{subscribe:Yl({user:null,loading:!0},(t=>function(e,t,n,r){return Ge(e).onAuthStateChanged(t,n,r)}(e,(async e=>{t(e?{user:{...e,displayName:e.displayName.split(" ")[0]},loading:!1}:{user:null,loading:!1})})))).subscribe},loginWithGoogle:()=>{const t=new Cn;return async function(e,t,n){const r=mn(e);Ct(t instanceof bn,e,"argument-error");const i=vr(r,n);return new Nr(r,"signInViaPopup",t,i).executeNotNull()}(e,t).then((async e=>{const{user:t}=e;if(t&&t.metadata.creationTime==t.metadata.lastSignInTime){const e=ql(Hl(),`users/info/${t.uid}`);await Al(e,{name:t.displayName.split(" ")[0],photo:t.photoURL}),await Rn(t,{displayName:t.displayName.split(" ")[0]})}}))},logout:()=>function(e){return Ge(e).signOut()}(e)}};function Ql(e){_(e,"svelte-194oe5h",".r-h-4.svelte-194oe5h{height:1rem}.r-w-4.svelte-194oe5h{width:1rem}")}function Zl(t){let n,r,i,o;return{c(){n=C("svg"),r=C("path"),i=C("polyline"),o=C("line"),$(r,"d","M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"),$(i,"points","16 17 21 12 16 7"),$(o,"x1","21"),$(o,"y1","12"),$(o,"x2","9"),$(o,"y2","12"),$(n,"xmlns","http://www.w3.org/2000/svg"),$(n,"width","24"),$(n,"height","24"),$(n,"viewBox","0 0 24 24"),$(n,"fill","none"),$(n,"stroke","currentColor"),$(n,"stroke-width","2"),$(n,"stroke-linecap","round"),$(n,"stroke-linejoin","round"),$(n,"class","r-h-4 r-w-4 svelte-194oe5h")},m(e,t){w(e,n,t),y(n,r),y(n,i),y(n,o)},p:e,i:e,o:e,d(e){e&&b(n)}}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
